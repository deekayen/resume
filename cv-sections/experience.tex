...
{ % Description(s) of tasks/responsibilities
Automated the creation and configuration of Windows and RedHat virtual machines using Ansible, Jenkins, git, and VMware PowerCLI.
}
...
{June 2015 - June 2016}
{ % Description(s) of tasks/responsibilities
Inspeced security measures for the protection of Ruby-based, AWS-hosted web application and IT environments. Monitored and analyzed security controls, reviewed vulnerabilities, maintained and enforced security policies, and performed risk assessments.
\begin{cvitems}
\item[]
